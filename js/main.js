...
/* harmony import */ var _components_show_more__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_show_more__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _components_rooms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/rooms */ "./src/js/components/rooms.js");
/* harmony import */ var _components_tips__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/tips */ "./src/js/components/tips.js");
...
(0,lightgallery__WEBPACK_IMPORTED_MODULE_0__["default"])(document.querySelector(".share__content"), {
  selector: '.share__row-item',
  speed: 600,
  mode: 'lg-fade',
  controls: true
});
...
showMore.addEventListener('click', () => {
  items += 3;
  const array = Array.from(document.querySelector('.products__col').children);
  const visItem = array.slice(0, items);
  visItem.forEach(el => el.classList.add('is-visible'));
  if (visItem.length === productsAll) {
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Parallax]);
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".hero__sliders", {
  observer: true,
  observeParents: true,
  slidesPerView: 1,
  spaceBetween: 32,
...
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper__WEBPACK_IMPORTED_MODULE_0__.Navigation, swiper__WEBPACK_IMPORTED_MODULE_0__.Pagination, swiper__WEBPACK_IMPORTED_MODULE_0__.Parallax]);
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".tips__slider", {
  observer: true,
  observeParents: true,
  slidesPerView: 3,
  spaceBetween: 32,
